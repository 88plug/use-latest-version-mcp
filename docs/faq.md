...
rate limits for the `github`, `ghcr`, and `swift` registries.
...
### How many tools and registries?

**15 tools** over **39 registries**. See [Tool Reference](reference/tools.md)
and [Supported Registries](reference/registries.md).
